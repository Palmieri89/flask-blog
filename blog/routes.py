...
def post_create():
  ...
  if form.validate_on_submit():
    ...
    new_post = Post(title=form.title.data.strip(), body=form.body.data, slug=slug, 
...
def post_update(post_id):
  ...
  form = PostForm()
  if form.validate_on_submit():
    post_instance.title = form.title.data.strip()
    ...
    form.title.data = post_instance.title.strip()
